__kernel void avg(read_only image2d_t img1, __const int2 img1dim, 
                 ...
                 write_only image3d_t img1avg, write_only image3d_t img2avg, __const int2 outdim)
{
...
__kernel void corr(read_only image2d_t img1, __const int2 img1dim, 
                  ...
                  write_only image3d_t imgO, __const int2 outdim)
{
    const sampler_t sampler = CLK_NORMALIZED_COORDS_FALSE | CLK_ADDRESS_CLAMP | CLK_FILTER_NEAREST;
    ...
    //float4 result = sum1 / (sqrt(sum2) * sqrt(sum3) + 1);
